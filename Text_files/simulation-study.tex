...
%\begin{figure}[H]
%\begin{center}
%    \caption{Variance of H-SBW estimator for known X}\label{fig:hsbwvarx}
...
%\begin{figure}[H]\label{fig:hsbwcoveragex}
%\begin{center}
%    \caption{H-SBW coverage for known X}\label{fig:simcoverage2}
